...
这些明星项目也说明了 Agent-first 氛围编程的固有缺点：更强的自主能力、更多工具、持久记忆和自我改进 Skill，本身并不能让代码仓库的演进变得可控。当 AI Agent 持续修改大型代码库时，问题仍然存在：谁来守住架构、验证真正重要的属性、阻止已经证明错误的写法再次出现，并决定哪些代码有资格留下？
