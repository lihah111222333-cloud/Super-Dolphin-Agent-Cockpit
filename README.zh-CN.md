...
Agent 系统的能力不是固定的。社区可以持续增加 Skill、MCP Server、Provider、工具、插件和工作流，使系统的功能达到甚至超过 Hermes Agent、OpenClaw 或当前其他领先 Agent。因此，Super Dolphin 不把“功能最多”或某一时点的单项能力最强定义为长期优势。
