...
func TestPrePushRunsFixTestGuardForPushedRange(t *testing.T) {
	...
	runFixTestGuardGit(t, root, "add", ".githooks/pre-push", "scripts/guard_commit_titles.sh", commitTitleEnforcementBaselinePath, "scripts/guard_fix_commits_have_tests.sh")
