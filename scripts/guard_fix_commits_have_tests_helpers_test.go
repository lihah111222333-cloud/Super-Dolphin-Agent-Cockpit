...
func commitPrePushGoOnlyChange(t *testing.T, root string) string {
	t.Helper()
	writeFixTestGuardFile(t, root, "go.mod", "module github.com/lihah111222333-cloud/super-dolphin-agent\n\ngo 1.22\n")
