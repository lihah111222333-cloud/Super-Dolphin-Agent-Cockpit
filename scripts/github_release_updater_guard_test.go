...
func TestGitHubReleasePublisherRunsAuthoritativeECIReleaseBeforeCreate(t *testing.T) {
	...
	assertScriptOrderAfter(t, script, "require_tag_greater_than_latest", "require_release_remote_run", "gh release create")
}
...
func TestGitHubReleasePublisherGuardsDraftPublish(t *testing.T) {
	...
	assertScriptOrderAfter(t, script, "require_tag_greater_than_latest", "require_release_remote_run", "gh release create \"$tag\"")
