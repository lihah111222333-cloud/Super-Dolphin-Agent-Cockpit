...
func testLSPServerFixtures() []testLSPServerFixture {
	return []testLSPServerFixture{
		...
		{id: "sqruff", path: "bin/sqruff", version: "sqruff-test"},
...
func writeMinimalPackagedMacOSApp(t *testing.T) string {
	...
	for _, path := range []string{
		...
		filepath.Join(resources, "bin", "sqruff"),
		...
		filepath.Join(resources, "lsp", "bin", "sqruff"),
...
func writeLSPManifest(t *testing.T, resources string) {
	...
	servers := []struct {
		...
		{id: "sqruff", path: "lsp/bin/sqruff", version: "sqruff-test"},
...
func writeMinimalPackagedLinuxStage(t *testing.T) string {
	...
	for _, path := range []string{
		...
		filepath.Join(stage, "bin", "sqruff"),
		...
		filepath.Join(stage, "lsp", "bin", "sqruff"),
