...
- Sub-agents MUST use `mcp-go-agent-orchestration` tools (`task_create_dag`, `task_start_dag`, `task_dispatch_node`, `task_update_node`) to manage task lifecycles, dependencies, and execution status.
