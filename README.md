...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 361 runnable `Test*` functions across 129 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
