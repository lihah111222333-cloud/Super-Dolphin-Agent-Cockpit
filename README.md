...
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 303 runnable `Test*` functions across 120 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
