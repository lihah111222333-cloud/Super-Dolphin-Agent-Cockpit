...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 335 runnable `Test*` functions across 128 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
