...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 329 runnable `Test*` functions across 123 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
