...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 371 runnable `Test*` functions across 132 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
