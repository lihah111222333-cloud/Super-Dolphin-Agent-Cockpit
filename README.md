...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 363 runnable `Test*` functions across 130 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
