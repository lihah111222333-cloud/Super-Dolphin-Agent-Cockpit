...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 471 runnable `Test*` functions across 164 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
