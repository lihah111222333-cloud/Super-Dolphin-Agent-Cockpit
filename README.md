...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 464 runnable `Test*` functions across 162 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
