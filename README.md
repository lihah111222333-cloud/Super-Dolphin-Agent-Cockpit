...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 420 runnable `Test*` functions across 146 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
