...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 411 runnable `Test*` functions across 142 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
