...
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 309 runnable `Test*` functions across 122 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
