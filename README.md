...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 468 runnable `Test*` functions across 163 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
