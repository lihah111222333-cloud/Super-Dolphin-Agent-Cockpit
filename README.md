...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 366 runnable `Test*` functions across 131 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
