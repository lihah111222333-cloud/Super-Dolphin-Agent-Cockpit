...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 472 runnable `Test*` functions across 165 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
