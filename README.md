...
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 319 runnable `Test*` functions across 126 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
