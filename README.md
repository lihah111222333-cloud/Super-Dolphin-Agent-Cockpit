...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 459 runnable `Test*` functions across 160 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
