...
| Metric | Value |
|--------|-------|
| Architecture Tests | <!-- BEGIN GENERATED ARCHTEST STATS -->Source AST: 413 runnable `Test*` functions across 144 `_test.go` files in `internal/archtest`<!-- END GENERATED ARCHTEST STATS --> |
