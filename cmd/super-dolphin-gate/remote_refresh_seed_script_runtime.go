...
if test "$BASELINE_STORAGE_MODE" = delta; then
  ...
  measure_layer "$source_archive_path"
  ...
  archive_layer "$go_cache_archive_path" cache-seed
  measure_layer "$go_cache_archive_path"
...
EOF
  ...
  archive_layer "$runtime_archive_path" runtime
  measure_layer "$runtime_archive_path"
  runtime_archive_digest=$layer_digest; runtime_archive_size=$layer_size
  source_archive_path=$oss_output/source.tar.gz
  archive_layer "$source_archive_path" source frontend-embed
  measure_layer "$source_archive_path"
  source_archive_digest=$layer_digest; source_archive_size=$layer_size
