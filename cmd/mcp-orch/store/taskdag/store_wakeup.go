...
type wakeupCommandStore struct {
	db sqlc.DBTX
	q  *sqlc.Queries
}
...
func newWakeupCommandStore(db sqlc.DBTX, q *sqlc.Queries) *wakeupCommandStore {
...
func (s *wakeupCommandStore) ClaimDueWakeups(ctx context.Context, input ClaimDueWakeupsInput) ([]Wakeup, error) {
...
func (s *wakeupLeaseStore) RenewWakeupLease(ctx context.Context, input RenewWakeupLeaseInput) (*Wakeup, int64, error) {
...
func (s *wakeupCommandStore) MarkWakeupSent(ctx context.Context, input MarkWakeupSentInput) (int64, error) {
...
func (s *wakeupCommandStore) BindWakeupTurn(ctx context.Context, input BindWakeupTurnInput) (int64, error) {
	return bindWakeupTurnTx(ctx, s.q, input, false)
}

// RetryWakeup 重新排队失败或超时的 wakeup。
func (s *wakeupCommandStore) RetryWakeup(ctx context.Context, input RetryWakeupInput) (int64, error) {
...
// 节点仍是旧配置的半提交状态。
func (s *wakeupCommandStore) RetryWakeupWithNodeConfigPatch(ctx context.Context, input RetryWakeupWithNodeConfigPatchInput) (int64, error) {
...
func (s *wakeupCommandStore) FailWakeup(ctx context.Context, input FailWakeupInput) (int64, error) {
...
// 改写新一轮调度的状态。
func (s *wakeupCommandStore) FailWakeupAndFailNodeAndCancelDownstream(ctx context.Context, wakeup FailWakeupInput, node FailNodeInput) (int64, *FailNodeResult, error) {
...
func (s *wakeupCommandStore) ReclaimStaleDispatchingWakeups(ctx context.Context) (int64, error) {
	return queryValueWrite(ctx, func() (int64, error) {
...
func (s *wakeupQueryStore) ListSentUnboundWakeups(ctx context.Context, targetAgentID string) ([]Wakeup, error) {
...
func (s *wakeupQueryStore) ListPendingOrDispatchingWakeups(ctx context.Context) ([]Wakeup, error) {
...
func (s *wakeupQueryStore) GetWakeup(ctx context.Context, id int64) (*Wakeup, error) {
