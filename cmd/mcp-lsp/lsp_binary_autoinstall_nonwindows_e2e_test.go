...
// 该 E2E 使用 POSIX fake installer，仅进入非 Windows 矩阵。
...
func allBinaryAutoInstallLanguageCases(t *testing.T) []binaryAutoInstallLanguageCase {
	t.Helper()
