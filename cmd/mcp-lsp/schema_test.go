...
func TestLSPToolSchemasRejectActionSpecificInvalidArguments(t *testing.T) {
	tests := []struct {
		...
		{name: "grep text rejects language", toolSchema: newLSPGrepSchema(), arguments: map[string]any{"action": "text_search", "query": "needle", "language": "go"}},
		...
		{name: "structure/workspace_symbol missing query", toolSchema: newLSPStructureSchema(), arguments: map[string]any{"action": "workspace_symbol", "language": "go"}},
		...
		{name: "structure/workspace_symbol conflicting locators", toolSchema: newLSPStructureSchema(), arguments: map[string]any{"action": "workspace_symbol", "query": "Handler", "file_path": "a.go", "language": "go"}},
		{name: "structure/workspace_symbol language rejects override", toolSchema: newLSPStructureSchema(), arguments: map[string]any{"action": "workspace_symbol", "query": "Handler", "language": "go", "language_id": "go"}},
...
func TestLSPToolSchemasAcceptCanonicalActionArguments(t *testing.T) {
	tests := []struct {
		...
		{name: "structure/workspace_symbol", toolSchema: newLSPStructureSchema(), arguments: map[string]any{"action": "workspace_symbol", "query": "Handler", "language": "go"}},
