...
func TestMcpLspSidecarRuntimeRequiresParentContract(t *testing.T) {
	_, err := runtimeenv.ResolveSidecarRuntimeContract(runtimeenv.SidecarRuntimeInput{
		ExecutablePath: "/Applications/Super Dolphin.app/Contents/Resources/bin/mcp-lsp",
...
func TestMcpLspSidecarRuntimeConsumesPackagedParentContract(t *testing.T) {
...
func TestMcpLspSidecarRuntimeDevParentIgnoresResidualPackagedEnv(t *testing.T) {
	contract, err := runtimeenv.ResolveSidecarRuntimeContract(runtimeenv.SidecarRuntimeInput{
		ExecutablePath: "/Applications/Super Dolphin.app/Contents/Resources/bin/mcp-lsp",
		Env: map[string]string{
