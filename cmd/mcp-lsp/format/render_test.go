...
func TestNormalizeForDisplayRegistryParity(t *testing.T) {
	...
	values := []any{
		...
		&hover,
		[]protocol.LocationResult{},
		[]protocol.DocumentSymbol{},
		workspaceEdit,
		[]protocol.TextEdit{},
		[]protocol.Diagnostic{},
		[]protocol.CodeActionResult{},
		[]protocol.WorkspaceSymbolResult{},
		[]protocol.CallHierarchyResult{},
		[]protocol.TypeHierarchyResult{},
		semanticTokens,
...
func TestNormalizeForDisplayPointerAndSliceNormalizers(t *testing.T) {
	location := &protocol.Location{
		...
		Range: protocol.Range{Start: protocol.Position{Line: 0, Character: 1}},
	}
	...
	inputSymbols := []protocol.DocumentSymbol{{
		Name:           "main",
