...
function finalizeRuntimeSnapshotPatch({
  ...
  const pruneCandidateMaps = [
    ...
    ['statusHeadersByThread', patch.statusHeadersByThread || state.statusHeadersByThread],
    ['statusDetailsByThread', patch.statusDetailsByThread || state.statusDetailsByThread],
    ['tokenUsageByThread', patch.tokenUsageByThread || state.tokenUsageByThread],
    ['agentRuntimeById', patch.agentRuntimeById || state.agentRuntimeById],
    ['activityStatsByThread', patch.activityStatsByThread || state.activityStatsByThread],
    ['alertsByThread', patch.alertsByThread || state.alertsByThread],
  ];
