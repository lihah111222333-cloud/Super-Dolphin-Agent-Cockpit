...
export function buildSyncContext(state, deps) {
  return {
    ...
    threadDiffLoadedRevisionByThread: reactive(new Map()),
    threadHistoryLoadedAtByThread: reactive(new Map()),
    threadHistoryProviderThreadIDByThread: reactive(new Map()),
    threadPatchSeqByThread: new Map(),
    threadPatchMetaByThread: reactive(new Map()),
    syncDebounceTimer: 0,
