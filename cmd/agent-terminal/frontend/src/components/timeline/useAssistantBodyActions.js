...
export function handleCopyButton(target, event, copyTextToClipboard) {
...
export function handleExpandButton(target, event) {
...
export function handleFileRefClick(target, event, emit) {
...
export function handleCitationClick(target, event, emit, items, focusCitationItem) {
