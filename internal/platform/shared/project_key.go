...
// ProjectKeyFromCwd resolves cwd to the skill-scoped project key used under
// ~/.multi-agent/skills/<project-key>/...
func ProjectKeyFromCwd(cwd string) string {
	return projectKeyFromCwd(cwd, SanitizeSkillProjectKey)
}

// MemoryProjectKeyFromCwd resolves cwd to the legacy memory/mcp-orch project
// key used under ~/.multi-agent/memory/projects/<project-key>/...
