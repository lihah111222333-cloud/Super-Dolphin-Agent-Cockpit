// Package mcpwire 提供 MCP server 与 toolbridge 共用的中立 wire primitives。
package mcpwire
...
// StructuredContentForToolResult 为工具结果生成 structuredContent。
...
// 对象原样保留，数组包装为 items，标量包装为 value，空输入返回空对象。
