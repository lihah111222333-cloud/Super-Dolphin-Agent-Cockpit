...
// NewStdioTransport creates a stdio MCP transport over stdin/stdout streams.
...
// Close closes the readable side when it also owns a closer.
...
// WriteMessage writes one JSON-RPC message to the transport.
