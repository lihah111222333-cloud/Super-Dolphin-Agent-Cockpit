...
func TestGoToolchainVersionParity(t *testing.T) {
	...
	var missing, stale, unknown []string
...
func registeredGoToolchainConsumers() map[string]goToolchainConsumer {
	return map[string]goToolchainConsumer{
		...
		"cmd/super-dolphin-gate/production_self_update_portable_go.go":         {Path: "cmd/super-dolphin-gate/production_self_update_portable_go.go", Reason: "官方 portable Go 下载清单"},
		"cmd/super-dolphin-gate/remote_candidate_test_binary_worker.go":        {Path: "cmd/super-dolphin-gate/remote_candidate_test_binary_worker.go", Reason: "远程测试构建身份"},
		"cmd/super-dolphin-gate/remote_refresh_seed_script.go":                 {Path: "cmd/super-dolphin-gate/remote_refresh_seed_script.go", Reason: "远程基线工具链安装"},
		"docs/契约/jrpc2-convention.md":                                          {Path: "docs/契约/jrpc2-convention.md", Reason: "当前 Go 契约版本"},
		"internal/devtools/gate/ci_query_store_remote_run_validation.go":       {Path: "internal/devtools/gate/ci_query_store_remote_run_validation.go", Reason: "持久化构建身份校验"},
		"internal/devtools/remoteci/candidate_test_binary_artifact.go":         {Path: "internal/devtools/remoteci/candidate_test_binary_artifact.go", Reason: "测试二进制清单校验"},
		"internal/devtools/remoteci/candidate_test_binary_builder_protocol.go": {Path: "internal/devtools/remoteci/candidate_test_binary_builder_protocol.go", Reason: "远程构建协议校验"},
...
func assertDerivedGoToolchainConsumers(t *testing.T, repository string) {
	...
	checks := map[string][]string{
		...
		"cmd/super-dolphin-gate/production_self_update_requirement.go": {"modfile.Parse", "parsed.Go.Version"},
