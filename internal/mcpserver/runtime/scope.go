...
// ToolScopeContextKey stores the trusted MCP tool scope in context.
const ToolScopeContextKey = contextKey("mcp_tool_scope")

// RuntimeWorkspaceScopeFallbackContextKey marks contexts allowed to fall back to runtime workspace scope.
