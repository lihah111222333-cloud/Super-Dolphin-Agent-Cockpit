// Package platform is the cross-tree shared library backing the notify
// module. It lives under internal/module/notify so the archtest
// dependency_direction rule permits both core and cmd/mcp-orch to
// import it (the plain internal/platform/ tree only lists an
// allow-list of 10 subpackages).
//
