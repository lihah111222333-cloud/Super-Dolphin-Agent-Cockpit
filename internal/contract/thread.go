...
// ThreadStateRuntimeConfigReader reads persisted thread-state runtime config
// without requiring an active provider session.
type ThreadStateRuntimeConfigReader interface {
