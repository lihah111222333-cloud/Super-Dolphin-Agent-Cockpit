...
var executorPrograms = map[GateID]ExecutorProgram{
	...
	GateIDFrontendPerformanceVerify: withFrontendSeed(requirePaths(commandProgramIn("frontend-app",
		[]string{"npm", "run", "performance:verify"},
	), append([]string{".git"}, FrontendPerformanceInputPaths()...)...)),
