...
func TestExecutorEnvironmentIsClosedAndUsesPrivateModuleMetadata(t *testing.T) {
	...
	for _, want := range []string{
		...
		"\nPATH=/opt/super-dolphin-gate/runtime/bin:/opt/super-dolphin-gate/runtime/go/bin:/opt/super-dolphin-gate/runtime/node/bin:/usr/local/go/bin:/usr/local/bin:/usr/bin:/bin\n",
