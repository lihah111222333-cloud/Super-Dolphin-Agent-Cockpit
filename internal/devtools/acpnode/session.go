...
func initializeParams(clientInfo any) (json.RawMessage, error) {
	return initializeParamsBounded(clientInfo, DefaultMaxMessage)
}
...
func buildPromptParams(sessionID string, p any) (json.RawMessage, error) {
	return buildPromptParamsBounded(DefaultMaxMessage, sessionID, p)
}
