...
func assertDependencyMutation(t *testing.T, baseline map[string]string) {
	...
	assertUnchangedTargets(t, baseline, dependencyChanged, []string{gate.FrontendPreflightTargetCriticalGuards, gate.FrontendPreflightTargetTurnContractVerify,
		gate.FrontendPreflightTargetTurnContractFieldGuard, gate.FrontendPreflightTargetCriticalTypecheck,
		gate.FrontendPreflightTargetContractsVitest, gate.FrontendPreflightTargetRPCAudit}, "dependency")
}
