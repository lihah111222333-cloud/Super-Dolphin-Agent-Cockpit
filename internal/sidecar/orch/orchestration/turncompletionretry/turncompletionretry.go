...
// Enqueuer describes a turncompletionretry API type.
type Enqueuer interface {
	EnqueueWakeup(context.Context, taskdag.EnqueueWakeupInput) (int64, error)
}

// CompleteOutcome describes a turncompletionretry API type.
...
// CompleteResult contains output returned by turncompletionretry operations.
...
// Enqueue runs a turncompletionretry operation.
...
// CompleteInput carries input for turncompletionretry operations.
...
// Complete runs a turncompletionretry operation.
