...
import (
	...
	"github.com/anthropic-ai/super-agent-v3/internal/sidecar/orch/orchestration/turncompletionretry"
	"github.com/anthropic-ai/super-agent-v3/internal/sidecar/orch/orchestration/wakeuptext"
...
// WakeupLauncher describes a orchestration API type.
type WakeupLauncher interface {
	LaunchAgent(ctx context.Context, req LaunchRequest) error
}

// WakeupDispatcher describes a orchestration API type.
