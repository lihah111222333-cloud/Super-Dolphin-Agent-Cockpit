...
// ErrDAGAgentRequiresRemoteLauncher identifies a nodeexec error condition.
var ErrDAGAgentRequiresRemoteLauncher = errors.New("DAG agent launch requires remote launcher")

// DAGAgentLaunchContractValidator describes a nodeexec API type.
...
// ErrSpawnWritebackFailed identifies a nodeexec error condition.
var ErrSpawnWritebackFailed = errors.New("agent spawn write-back failed")

// AgentLauncherWithSpawnRecord describes a nodeexec API type.
...
// LaunchedThreadStopper describes a nodeexec API type.
...
//
// 与 internal/sidecar/orch/orchestration/launcherrors/errors.go::Classify
