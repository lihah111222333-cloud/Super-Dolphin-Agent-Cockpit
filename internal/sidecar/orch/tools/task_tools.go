...
// CreateDAGInput carries input for tools operations.
...
// DAGScheduleInput carries input for tools operations.
...
// CreateDAGNodeInput carries input for tools operations.
...
// DAGExecutionInput carries input for tools operations.
...
// DAGKeyInput carries input for tools operations.
type DAGKeyInput struct {
	DagKey string `json:"dag_key"`
	Pos    string `json:"pos,omitempty"`
}

// ListDAGsInput carries input for tools operations.
...
// ListDAGsOutput contains output returned by tools operations.
...
// ListRunsOutput contains output returned by tools operations.
...
// UpdateNodeInput carries input for tools operations.
...
// DeleteDAGInput carries input for tools operations.
