...
// DefaultPath is part of the modelregistry package API.
const DefaultPath = "internal/sidecar/orch/tools/modelregistry/models.yaml"

// EnvRegistryPath is part of the modelregistry package API.
const EnvRegistryPath = "SUPER_DOLPHIN_MODEL_REGISTRY"

// ProviderModels describes a modelregistry API type.
...
// Registry describes a modelregistry API type.
type Registry interface {
	ListProviders() ([]ProviderModels, error)
	LookupProvider(name string) (ProviderModels, bool, error)
}

// FileRegistry describes a modelregistry API type.
...
// StaticRegistry describes a modelregistry API type.
...
// FileRegistryOption configures modelregistry behavior.
