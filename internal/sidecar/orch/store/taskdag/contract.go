...
// OrchestrationStore is the narrow port consumed by internal/sidecar/orch/orchestration
...
// UnitOfWorkStore defines persistence operations used by the taskdag package.
...
// DAGReadStore defines persistence operations used by the taskdag package.
type DAGReadStore interface {
	DAGDetailStore
	ListDAGs(ctx context.Context, filter ListDAGsFilter) ([]DAG, error)
}

// DAGDetailStore defines persistence operations used by the taskdag package.
...
// NodeStatusStore defines persistence operations used by the taskdag package.
...
// DAGDeleteStore defines persistence operations used by the taskdag package.
type DAGDeleteStore interface {
	DeleteDAG(ctx context.Context, dagKey string) (int64, error)
}

// DAGLockStore defines persistence operations used by the taskdag package.
...
// RecoveryStore defines persistence operations used by the taskdag package.
...
// RunningNodeStore defines persistence operations used by the taskdag package.
...
// WakeupStore defines persistence operations used by the taskdag package.
...
// WorkerLeaseStore defines persistence operations used by the taskdag package.
...
// ListDAGsFilter carries input for taskdag operations.
...
// NodeStatusUpdate describes a taskdag API type.
...
// AssignNodeInput carries input for taskdag operations.
...
// BindRunningNodeTurnInput carries input for taskdag operations.
...
// TouchRunningNodeEventInput carries input for taskdag operations.
...
// RunningNodeStatusUpdate describes a taskdag API type.
...
// AwaitingVerifyNodeStatusUpdate describes a taskdag API type.
...
// CompleteNodeInput carries input for taskdag operations.
...
// NodeConfigPatchInput carries input for taskdag operations.
...
// RetryWakeupWithNodeConfigPatchInput carries input for taskdag operations.
type RetryWakeupWithNodeConfigPatchInput struct {
	RetryWakeup RetryWakeupInput
	NodeConfig  NodeConfigPatchInput
}

// OutputMaterializationClaimInput carries input for taskdag operations.
...
// FlexibleNodeStatusUpdate describes a taskdag API type.
...
// EnqueueWakeupInput carries input for taskdag operations.
...
// ClaimDueWakeupsInput carries input for taskdag operations.
...
// MarkWakeupSentInput carries input for taskdag operations.
...
// BindWakeupTurnInput carries input for taskdag operations.
type BindWakeupTurnInput struct {
	TurnID string
	ID     int64
}

// RetryWakeupInput carries input for taskdag operations.
...
// FailWakeupInput carries input for taskdag operations.
...
// AcquireWorkerLeaseInput carries input for taskdag operations.
...
// RenewWorkerLeaseInput carries input for taskdag operations.
...
// ReleaseWorkerLeaseInput carries input for taskdag operations.
type ReleaseWorkerLeaseInput struct {
	TargetAgentID string
	OwnerID       string
}

// DAG describes a taskdag API type.
type DAG struct {
	ID          int64
	DagKey      string
	Version     int64
...
// DAGSchedule describes a taskdag API type.
type DAGSchedule struct {
	Trigger  string
	CronExpr string
}

// UpdateDAGPatchInput carries input for taskdag operations.
...
// Node describes a taskdag API type.
type Node struct {
	ID             int64
	DagKey         string
	NodeKey        string
...
// Wakeup describes a taskdag API type.
type Wakeup struct {
	ID             int64
	DagKey         string
	NodeKey        string
...
// WorkerLease describes a taskdag API type.
...
// TerminateRunResult contains output returned by taskdag operations.
...
// ScheduledStartTxStore defines persistence operations used by the taskdag package.
...
// ScheduledStartStore defines persistence operations used by the taskdag package.
