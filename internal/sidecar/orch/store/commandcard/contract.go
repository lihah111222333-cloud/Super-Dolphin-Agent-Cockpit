...
// Reader describes a commandcard API type.
type Reader interface {
	List(ctx context.Context, filter ListFilter) ([]CommandCard, error)
}

// ListFilter carries input for commandcard operations.
type ListFilter struct {
	Keyword string
	Limit   int32
}

// CommandCard describes a commandcard API type.
...
// Store defines persistence operations used by the commandcard package.
...
// CommandCardVersion describes a commandcard API type.
