 ...
 */
template <typename T> T square_area(T length) { return length * length; }
 ...
 */
template <typename T> T rect_area(T length, T width) { return length * width; }
 ...
 */
template <typename T> T triangle_area(T base, T height) {
 ...
 */
template <typename T> T circle_area(T radius) { return M_PI * pow(radius, 2); }
 ...
 */
template <typename T> T parallelogram_area(T base, T height) {
  return base * height;
}
 ...
 */
template <typename T> T cube_surface_area(T length) {
 ...
 */
template <typename T> T sphere_surface_area(T radius) {
 ...
 */
template <typename T> T cylinder_surface_area(T radius, T height) {
  return 2 * M_PI * radius * height + 2 * M_PI * pow(radius, 2);
}

/**
 * @brief surface area of a
 * [hemi-sphere](https://en.wikipedia.org/wiki/Surface_area) ( 3 * pi * r^2)
 * @param radius is the radius of the hemi-sphere
 * @tparam T datatype of radius
 * @returns surface area of the hemi-sphere
 */
template <typename T> T hemi_sphere_surface_area(T radius) {
