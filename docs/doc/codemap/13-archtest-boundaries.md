...
| `command_narrow_import_surface` | `command_boundary` | `allow_internal_imports` | `cmd/acp-node/**/*.go`<br>`cmd/agent-runtime/**/*.go`<br>`cmd/agent-terminal/**/*.go`<br>`cmd/codex-worktree-setup/**/*.go`<br>`cmd/mcp-schema-compiler-helper/**/*.go`<br>`cmd/super-dolphin-gate/**/*.go`<br>`cmd/super-dolphin-guard/**/*.go`<br>`cmd/super-dolphin-release-manifest/**/*.go`<br>`cmd/super-dolphin-updater/**/*.go` | 26 policies across 9 file patterns | — | — | — | standalone commands may import only their registered application or runtime seams |
...
|---|---|---|---|---|---|
| `acp_node_boundary` | `internal/archtest/acp_node_boundary_guard_test.go` | — | `TestACPNodeBoundary`<br>`TestACPNodeStdlibOnlyBoundary` | `cmd/acp-node`<br>`internal/devtools` | experimental ACP development code must remain isolated from production provider, UI, RPC, and persistence surfaces |
