...
|---|------|---------|
| 01 | [01-terminal-ui.md](01-terminal-ui.md) | 终端入口与 UI 层拆卷索引 |
| 01a | [01-terminal-ui-go.md](01-terminal-ui-go.md) | Go 桌面端 / Wails 运行时 / 内置 RPC / 多窗口 / 代码预览 |
| 01b | [01-terminal-ui-vue.md](01-terminal-ui-vue.md) | Vue 前端占位卷（A01b 负责） |
...
- 11 号卷已拆为：
  - [11-memory.md](11-memory.md)：memory 主链
  - [11-prompt-thread.md](11-prompt-thread.md)：prompt + thread 启停 / snapshot / provider bridge
- 保留 [11-memory-prompt-thread.md](11-memory-prompt-thread.md) 作为入口索引，避免 `ai-index.json` 与既有引用立即失效。
>>>>>>> Stashed changes
