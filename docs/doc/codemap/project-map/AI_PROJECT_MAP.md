...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1075 | 197.7 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 661 | 129.1 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2199 | 应用内部模块、平台、provider、store 与守卫 |
...
| `internal/platform/toolbridge` | 91 | provider 与 MCP tools 桥接 |
