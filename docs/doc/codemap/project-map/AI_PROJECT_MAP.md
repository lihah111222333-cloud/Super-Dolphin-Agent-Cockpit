...
| `docs/doc/codemap/project-map/index/other.tsv` | 1117 | 222.3 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2666 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 813 | 可执行入口与 MCP peer |
...
| `cmd/mcp-orch/orchestration` | 183 | agent 生命周期、DAG、wakeup、report 与 hook 消费 |
