...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1201 | 222.5 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `cmd/mcp-lsp/multilsp` | 82 | 多语言 LSP manager、transport 与缓存 |
