...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1212 | 224.7 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `cmd/mcp-lsp/multilsp` | 83 | 多语言 LSP manager、transport 与缓存 |
