...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 956 | 200.4 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/modules.tsv` | 742 | 144.4 KB | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 703 | 137.6 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2265 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 950 | 代码地图、ADR、计划、迁移和内部说明 |
| `frontend-app` | 950 | 当前 React/Vite 新 UI |
