...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1150 | 212.7 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2478 | 应用内部模块、平台、provider、store 与守卫 |
