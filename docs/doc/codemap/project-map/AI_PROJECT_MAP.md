...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 445 | 90.0 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/modules.tsv` | 722 | 140.5 KB | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 898 | 160.4 KB | 代码地图、ADR/决策、计划与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 592 | 115.3 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2084 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 895 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 668 | 可执行入口与 MCP peer |
| `frontend-app` | 443 | 当前 React/Vite 新 UI |
| `scripts` | 113 | 工程自动化脚本 |
...
| 子系统 | 文件数 | 职责 |
|---|---:|---|
| `internal/app` | 74 | root Fx 装配、runtime bridge、toolbridge adapters 与 graph closure tests |
...
| `internal/platform/toolbridge` | 77 | provider 与 MCP tools 桥接 |
...
| 子系统 | 文件数 | 职责 |
|---|---:|---|
| `internal/provider/codexapp` | 121 | Codex app/server provider 集成 |
