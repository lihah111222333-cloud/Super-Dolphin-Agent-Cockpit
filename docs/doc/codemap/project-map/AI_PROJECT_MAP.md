...
| `docs/doc/codemap/project-map/index/other.tsv` | 664 | 129.6 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2204 | 应用内部模块、平台、provider、store 与守卫 |
...
| `internal/app` | 95 | 全域汇总（root + adapter packages） |
