...
| 索引文件 | 文件数 | 覆盖范围 |
|---|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 607 | 桌面应用、Wails host、Vue/Vite 前端与 UI 测试 |
| `docs/doc/codemap/project-map/index/orchestration.tsv` | 319 | mcp-orch 编排 peer、DAG、workspace、prompt、command、shared-file 工具 |
| `docs/doc/codemap/project-map/index/modules.tsv` | 591 | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 677 | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
| `docs/doc/codemap/project-map/index/store-sql.tsv` | 277 | 持久化层：store、sqlc、SQL queries、migrations |
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 1390 | 代码地图、ADR/决策、计划、agent skills/workflows 与项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 352 | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 1509 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 1072 | 可执行入口与 MCP peer |
| `docs` | 533 | 代码地图、ADR、计划、迁移和内部说明 |
| `.agent` | 438 | 项目级 agent 技能与工作流 canonical |
| `.agents` | 417 | agent/Codex mirror 入口 |
| `migrations` | 107 | 数据库 migration |
| `scripts` | 42 | 工程自动化脚本 |
