...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 313 | 62.3 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 851 | 151.3 KB | 代码地图、ADR/决策、计划与 docs 项目知识 |
...
| `docs` | 848 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 643 | 可执行入口与 MCP peer |
| `frontend-app` | 311 | 当前 React/Vite 新 UI |
