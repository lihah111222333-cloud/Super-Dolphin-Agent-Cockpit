...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 605 | 123.2 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1030 | 189.6 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2162 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 936 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 648 | 可执行入口与 MCP peer |
| `frontend-app` | 603 | 当前 React/Vite 新 UI |
| `scripts` | 132 | 工程自动化脚本 |
| `pkg` | 30 | 可复用公共库 |
