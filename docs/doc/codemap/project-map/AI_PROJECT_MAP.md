...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1131 | 208.9 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 715 | 140.4 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2299 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 951 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 677 | 可执行入口与 MCP peer |
