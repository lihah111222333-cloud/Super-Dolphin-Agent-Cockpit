...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1219 | 226.2 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2640 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 782 | 可执行入口与 MCP peer |
...
| `cmd/mcp-lsp/multilsp` | 88 | 多语言 LSP manager、transport 与缓存 |
