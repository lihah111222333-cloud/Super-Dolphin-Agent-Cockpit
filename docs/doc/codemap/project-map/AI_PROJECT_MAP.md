...
| `docs/doc/codemap/project-map/index/orchestration.tsv` | 409 | 91.6 KB | mcp-orch 编排 peer、DAG、workspace、prompt、command、shared-file 工具 |
...
| `cmd/mcp-orch/orchestration` | 170 | agent 生命周期、DAG、wakeup、report 与 hook 消费 |
