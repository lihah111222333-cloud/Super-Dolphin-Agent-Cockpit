...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1001 | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 466 | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 1965 | 应用内部模块、平台、provider、store 与守卫 |
