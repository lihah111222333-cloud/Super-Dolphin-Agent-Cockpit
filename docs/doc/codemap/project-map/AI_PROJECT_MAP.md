...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1197 | 221.9 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2638 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 761 | 可执行入口与 MCP peer |
