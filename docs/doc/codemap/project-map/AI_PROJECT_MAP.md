...
| `docs/doc/codemap/project-map/index/orchestration.tsv` | 411 | 92.1 KB | mcp-orch 编排 peer、DAG、workspace、prompt、command、shared-file 工具 |
...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 865 | 153.8 KB | 代码地图、ADR/决策、计划与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 503 | 95.9 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 1998 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 862 | 代码地图、ADR、计划、迁移和内部说明 |
...
| `cmd/mcp-orch/orchestration` | 172 | agent 生命周期、DAG、wakeup、report 与 hook 消费 |
