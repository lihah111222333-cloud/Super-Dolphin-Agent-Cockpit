...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 634 | 128.8 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 955 | 172.1 KB | 代码地图、ADR/决策、计划与 docs 项目知识 |
...
| `frontend-app` | 629 | 当前 React/Vite 新 UI |
| `scripts` | 140 | 工程自动化脚本 |
| `pkg` | 30 | 可复用公共库 |
