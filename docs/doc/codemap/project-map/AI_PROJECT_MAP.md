...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 930 | 166.3 KB | 代码地图、ADR/决策、计划与 docs 项目知识 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2136 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 922 | 代码地图、ADR、计划、迁移和内部说明 |
