...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 622 | 126.5 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1096 | 202.1 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 691 | 134.9 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2242 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 946 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 662 | 可执行入口与 MCP peer |
| `frontend-app` | 617 | 当前 React/Vite 新 UI |
| `scripts` | 137 | 工程自动化脚本 |
| `pkg` | 30 | 可复用公共库 |
...
| `internal/platform/toolbridge` | 102 | provider 与 MCP tools 桥接 |
