...
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 847 | 代码地图、ADR/决策、计划与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 469 | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 1968 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 844 | 代码地图、ADR、计划、迁移和内部说明 |
