...
| `docs/doc/codemap/project-map/index/other.tsv` | 511 | 97.7 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2009 | 应用内部模块、平台、provider、store 与守卫 |
...
| `internal/module/skill` | 98 | skill canonical 管理与 provider-native mirror |
