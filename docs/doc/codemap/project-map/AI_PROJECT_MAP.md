...
| `docs/doc/codemap/project-map/index/modules.tsv` | 749 | 145.7 KB | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2284 | 应用内部模块、平台、provider、store 与守卫 |
...
| 子系统 | 文件数 | 职责 |
|---|---:|---|
| `internal/module/thread` | 112 | thread start/resume/fork/stop 生命周期与绑定真相源 |
