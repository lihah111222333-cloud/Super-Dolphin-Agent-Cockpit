...
| `docs/doc/codemap/project-map/index/other.tsv` | 601 | 117.6 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2095 | 应用内部模块、平台、provider、store 与守卫 |
...
| 子系统 | 文件数 | 职责 |
|---|---:|---|
| `internal/app` | 83 | root Fx 装配、runtime bridge、toolbridge adapters 与 graph closure tests |
