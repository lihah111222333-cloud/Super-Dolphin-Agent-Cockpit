...
| `docs/doc/codemap/project-map/index/modules.tsv` | 723 | 140.8 KB | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2121 | 应用内部模块、平台、provider、store 与守卫 |
