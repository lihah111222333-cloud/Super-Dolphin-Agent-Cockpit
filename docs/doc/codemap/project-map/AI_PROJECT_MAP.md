...
| `docs/doc/codemap/project-map/index/modules.tsv` | 737 | 143.4 KB | 业务模块层：dashboard、memory、prompt、skill、thread、turn、uistate 等 |
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1096 | 202.0 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2229 | 应用内部模块、平台、provider、store 与守卫 |
