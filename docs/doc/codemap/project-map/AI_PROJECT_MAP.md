...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1281 | 238.3 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
| `docs/doc/codemap/project-map/index/store-sql.tsv` | 231 | 36.1 KB | 持久化层：store、sqlc、SQL queries、migrations |
| `docs/doc/codemap/project-map/index/remote-ci.tsv` | 218 | 59.0 KB | 远程 CI：Git hooks、strict SQLite authority、阿里云 ECI/OSS、ImageCache 与 shard worker |
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 96 | 14.3 KB | 代码地图、ADR、契约与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 1078 | 214.3 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2838 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 874 | 可执行入口与 MCP peer |
...
| `internal/devtools/remoteci` | 113 | coordinator、source transport、workload identity 与 timing |
