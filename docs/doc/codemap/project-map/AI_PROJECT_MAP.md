...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1277 | 237.4 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
| `docs/doc/codemap/project-map/index/store-sql.tsv` | 231 | 36.1 KB | 持久化层：store、sqlc、SQL queries、migrations |
| `docs/doc/codemap/project-map/index/remote-ci.tsv` | 216 | 58.5 KB | 远程 CI：Git hooks、strict SQLite authority、阿里云 ECI/OSS、ImageCache 与 shard worker |
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 96 | 14.3 KB | 代码地图、ADR、契约与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 1074 | 213.4 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| `internal/devtools/remoteci` | 116 | coordinator、source transport、workload identity 与 timing |
| `internal/devtools/cicontract` | 11 | ECI/ImageCache/SQLite canonical contract owner |
