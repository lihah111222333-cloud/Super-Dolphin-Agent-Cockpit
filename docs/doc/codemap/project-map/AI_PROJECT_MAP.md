...
| `docs/doc/codemap/project-map/index/remote-ci.tsv` | 259 | 70.3 KB | 远程 CI：Git hooks、strict SQLite authority、阿里云 ECI/OSS、ImageCache 与 shard worker |
| `docs/doc/codemap/project-map/index/docs-agent.tsv` | 98 | 14.6 KB | 代码地图、ADR、契约与 docs 项目知识 |
| `docs/doc/codemap/project-map/index/other.tsv` | 1181 | 236.0 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2966 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 900 | 可执行入口与 MCP peer |
| `frontend-app` | 758 | 当前 React/Vite 新 UI |
| `scripts` | 191 | 工程自动化脚本 |
| `docs` | 91 | 当前文档、生成索引、开发中材料与历史证据 |
| `pkg` | 30 | 可复用公共库 |
...
| `internal/devtools/remoteci` | 135 | coordinator、source transport、workload identity 与 timing |
