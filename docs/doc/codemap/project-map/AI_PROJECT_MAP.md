...
| 索引文件 | 文件数 | 覆盖范围 |
|---|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 380 | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
| `docs/doc/codemap/project-map/index/orchestration.tsv` | 394 | mcp-orch 编排 peer、DAG、workspace、prompt、command、shared-file 工具 |
...
| `frontend-app` | 274 | 其他项目资源 |
| `.mypy_cache` | 258 | 其他项目资源 |
| `codex-app 2` | 141 | 其他项目资源 |
