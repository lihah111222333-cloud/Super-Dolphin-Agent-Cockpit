...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 557 | 113.7 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 672 | 131.3 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2218 | 应用内部模块、平台、provider、store 与守卫 |
| `docs` | 946 | 代码地图、ADR、计划、迁移和内部说明 |
| `cmd` | 662 | 可执行入口与 MCP peer |
| `frontend-app` | 552 | 当前 React/Vite 新 UI |
| `scripts` | 133 | 工程自动化脚本 |
| `pkg` | 30 | 可复用公共库 |
