...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 702 | 143.4 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/platform-provider.tsv` | 1149 | 212.5 KB | 基础设施与 provider 集成：RPC、hooks、toolbridge、Claude/Codex/统一 provider |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 963 | 192.6 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| 模块 | 文件数 | 职责 |
|---|---:|---|
| `internal` | 2477 | 应用内部模块、平台、provider、store 与守卫 |
| `cmd` | 750 | 可执行入口与 MCP peer |
| `frontend-app` | 696 | 当前 React/Vite 新 UI |
| `scripts` | 173 | 工程自动化脚本 |
