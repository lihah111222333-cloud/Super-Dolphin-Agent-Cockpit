...
| 索引文件 | 文件数 | 大小 | 覆盖范围 |
|---|---:|---:|---|
| `docs/doc/codemap/project-map/index/app-ui.tsv` | 555 | 113.5 KB | 桌面应用、Wails host、React/Vite 前端与 UI 测试 |
...
| `docs/doc/codemap/project-map/index/other.tsv` | 662 | 129.0 KB | 公共库、脚本、测试、配置与其他根级资源 |
...
| `frontend-app` | 553 | 当前 React/Vite 新 UI |
| `scripts` | 130 | 工程自动化脚本 |
| `pkg` | 30 | 可复用公共库 |
