...
> 状态：📝 Proposed | 日期：2026-05-11 | 决策者：待定 | 相关：`docs/adr/0001-dag-v2-contracts.md`（§2 FailureClass 7 类枚举 / S1.2 done）、`cmd/mcp-orch/orchestration/nodeexec/executor_agent.go`（F1.1 已实装 4 处映射）、`docs/plans/dag改造现状与补丁v2.md` §4.5
