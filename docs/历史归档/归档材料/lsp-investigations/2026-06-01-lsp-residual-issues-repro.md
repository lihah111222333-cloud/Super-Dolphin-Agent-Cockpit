...
| direction | `outgoing` |
| pos | `/Users/mima0000/Desktop/wj/super-agent-v3/internal/sidecar/lsp/tools/tool_file.go:131:21` |
| max_results | `8` |
...
| pos | 结果 |
|:---|:---|
| `/Users/mima0000/Desktop/wj/super-agent-v3/internal/sidecar/lsp/tools/tool_file.go:131:25` | `call_hierarchy` 正常返回 `handleFile` 的 outgoing 调用 |
