...
v3 `tools/list` 当前暴露短名：`file/inspect/xref/grep/structure/edit/completion`，见 `internal/sidecar/lsp/tools.go:29-38`；但 legacy alias 只在 call 时映射，见 `internal/sidecar/lsp/tools.go:41-49`。v2 明确暴露 `lsp_file/lsp_inspect/...`，见 `/Users/mima0000/Desktop/wj/go-agent-v2/pkg/toolsdk/tools/lsp_tools.go:33-55`。
...
1. 修改 `internal/sidecar/lsp/tools.go`：`tools/list` 暴露 legacy names；call path 保持 canonical alias。
2. 修改 `cmd/mcp-lsp/schema.go` 与 `internal/sidecar/lsp/tools/tool_edit.go`：加入 `force` 并测试。
...
4. 修改 `internal/sidecar/lsp/tools/factory.go`：统一空列表 envelope。
...
required_tests=(
  ...
  './internal/sidecar/lsp/tools:TestEditForceDoesNotBypassTrustedScopeOrPathSafety'
  ...
  './internal/sidecar/lsp/tools:TestCursorErrorIncludesOneBasedHint'
  './internal/sidecar/lsp/tools:TestRenderListResultEmptyEnvelope'
  './internal/sidecar/lsp/tools:TestLanguageOverrideParticipatesInCacheKey'
  './internal/sidecar/lsp/tools:TestStructuredToolErrorEnvelopeIsLanguageAgnosticForGoPythonAndTypeScript'
)
run_required_test() {
  local pkg="$1"
  local test_name="$2"
