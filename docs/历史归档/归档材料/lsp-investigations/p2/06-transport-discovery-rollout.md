...
required_tests=(
  ...
  './internal/sidecar/lsp/multilsp:TestAgentStopTriggersLSPReleaseScope'
  './internal/mcpserver/common:TestRollbackKeepsHTTPMCPCompatibility'
  './internal/sidecar/lsp/manager:TestMultiLanguageLSPGateCoversRegisteredLanguages'
)
run_required_test() {
  local pkg="$1"
  local test_name="$2"
...
set -euo pipefail
required_tests=(
  './internal/sidecar/lsp/multilsp:TestGenericLanguageServicesBootstrapCacheDiagnosticsMatrix'
  './internal/sidecar/lsp/multilsp:TestDeadClientRestartRebootstrapForRegisteredLanguageIDs'
  './internal/sidecar/lsp/multilsp:TestDiagnosticsAllNoCrossLanguageCacheLeak'
  './internal/sidecar/lsp/multilsp:TestCacheKeySeparatesLanguageIDAcrossSameURI'
  './internal/sidecar/lsp/tools:TestToolErrorEnvelopeLanguageAgnostic'
  './internal/sidecar/lsp/multilsp:TestGOWORKDoesNotAffectNonGoLanguageAdapters'
  './internal/sidecar/lsp/multilsp:TestAdapterLanguageSpecificHashFeedsWorkspaceKey'
  './internal/sidecar/lsp/multilsp:TestLanguageAdapterRegistryOwnsRootEnvBootstrapPolicy'
  './internal/sidecar/lsp/multilsp:TestGenericManagerHasNoLanguageSpecificRootBranches'
  './internal/sidecar/lsp/multilsp:TestGenericLanguageServicesMatrixCoversGoJSTSPythonRustJavaCSS'
  './internal/sidecar/lsp/multilsp:TestNonLSPDocumentLanguagesUseCapabilityFallback'
)
run_required_test() {
  local pkg="$1"
  local test_name="$2"
...
optional_smoke ./internal/sidecar/lsp/manager TestMultiLanguageLSP_E2E e2e multilang-e2e
```
