...
- `internal/sidecar/orch/store/sqlc/command_card.sql.go`（DeleteCommandCard、GetCommandCard、InsertCommandCardVersion、ListCommandCardVersions、ListCommandCards、UpsertCommandCard）
- `internal/sidecar/orch/store/sqlc/shared_file.sql.go`（DeleteSharedFile、GetSharedFile、ListSharedFiles、UpsertSharedFile）
