...
- `internal/sidecar/lsp/multilsp/scope.go`（ResolveLSPToolScope、canonicalizeLSPToolScope、buildScopeKey、buildWorkspaceKey、canonicalScopePath、canonicalScopeURI、normalizeScopeWorkspaceRoots、selectWorkspaceRootForTarget、ensurePathWithinWorkspaceRoots、shardIndexForKey）
- `internal/sidecar/orch/store/taskdag/store_lease.go`（AcquireWorkerLease、RenewWorkerLease、ReleaseWorkerLease）
- `internal/sidecar/orch/store/sqlc/task_dag_worker_lease.sql.go`（AcquireTaskDagWorkerLease、RenewTaskDagWorkerLease、ReleaseTaskDagWorkerLease SQL）
- `internal/sidecar/orch/store/commandcard/store.go`（Get/Upsert/List/Delete/InsertVersion/ListVersions、timePtr）
