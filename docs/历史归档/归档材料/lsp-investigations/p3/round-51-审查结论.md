...
- `internal/sidecar/orch/orchestration/node_router.go`（NodeExecutorRouter、NewNodeExecutorRouter、WithEventBus、spawnReplanPlanner、sanitizeReplanLaunchName、buildReplanPlannerPrompt）
