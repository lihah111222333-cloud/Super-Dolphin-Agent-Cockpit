...
- `internal/sidecar/lsp/multilsp/manager_retry.go`（canAutoRetryDeadClientRequest、nonReplayableDeadClientError、rebuildClientAfterNonReplayableFailure）
- `internal/sidecar/lsp/middleware/recovery.go`（Recovery middleware）
- `internal/sidecar/lsp/middleware/logging.go`（Chain、Logging、compactAny、compactValue）
- `internal/sidecar/lsp/multilsp/manager_symbols_fallback.go`（fallbackDocumentSymbols、parseMarkdownSymbols、parseJSONSymbols、parseYAMLSymbols、buildLevelSymbols）
- `internal/sidecar/lsp/middleware/budget_hints.go`（lookupHint、extractSummary）
