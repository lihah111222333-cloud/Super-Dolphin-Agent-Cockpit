...
- `internal/sidecar/orch/store/commandcard/module.go`、`internal/sidecar/orch/store/sharedfile/module.go`（fx wiring）
- `internal/sidecar/orch/orchestration/nodeexec/stubs.go`（HybridExecutor stub，再回访验证）
