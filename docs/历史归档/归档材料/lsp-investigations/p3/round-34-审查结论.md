...
- `internal/sidecar/lsp/edit/seeksequence.go`（SeekSequence、seekSequenceBounds、seekSequenceMode、collectSequenceMatches、sequenceMatchAt、lineMatch、normalizeUnicode、normalizeEscape）
- `internal/sidecar/orch/store/sharedfile/store.go`（Upsert、Get、List、Delete、writeDiskAndDecideInline、mapSharedFile）
