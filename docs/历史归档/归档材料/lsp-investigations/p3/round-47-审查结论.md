...
- `internal/sidecar/orch/orchestration/exit_monitor.go`（processExitMonitor、Arm、Emit、ExitEvents、Drain、publishExit、claimFire、exitMonitorFenceKey）
- `internal/sidecar/orch/orchestration/launcher_protocol.go`（LauncherMethod* 常量、LauncherParam* 常量、LauncherResp* 常量、launcherResponseAlias、resolveLauncherThreadStartAlias）
