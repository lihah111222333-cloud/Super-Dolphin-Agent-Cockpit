...
- `internal/sidecar/orch/store/sqlc/db.go`（DBTX interface、Queries、WithTx）
- `internal/sidecar/orch/store/sqlc/task_ack.sql.go`（ListTaskAcks、UpsertTaskAck）
- `internal/sidecar/orch/store/sqlc/workspace_run.sql.go`（GetWorkspaceRun、ListWorkspaceRuns、TransitionWorkspaceRunStatus、UpdateWorkspaceRunStatus、UpsertWorkspaceRun、UpsertWorkspaceRunFile、ListWorkspaceRunFiles）
- `internal/sidecar/orch/store/commandcard/contract.go`（Reader、Store、CommandCard、CommandCardVersion、ListFilter）
- `internal/sidecar/orch/store/sharedfile/contract.go`（Reader、Store、SharedFile、UpsertParams、ListFilter）
