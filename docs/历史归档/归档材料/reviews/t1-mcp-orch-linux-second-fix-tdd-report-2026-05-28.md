...
--- FAIL: TestPackageLinuxCopyModelRegistryFailsFastWhenSourceMissing (0.08s)
    package_linux_guard_test.go:52: copy_model_registry output = "package_linux.sh must run with GOOS=linux; current GOOS=darwin", want "missing model registry: /var/folders/.../internal/sidecar/orch/tools/modelregistry/models.yaml"
FAIL
