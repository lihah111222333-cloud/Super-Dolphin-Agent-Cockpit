...
建议：像 macOS 一样复制 `internal/sidecar/orch/tools/modelregistry/models.yaml` 到包内，并在 `run.sh` 中设置 `SUPER_DOLPHIN_MODEL_REGISTRY="$here/models.yaml"`；增加 Linux package guard test。
