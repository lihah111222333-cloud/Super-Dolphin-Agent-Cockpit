...
**Files:**
- Create: `docs/ai01-docs/plan/2026-05-22-full-test-remediation-plan.md`

- [ ] 保存本计划到目标路径。
- [ ] `git status --short --branch`，确认只有既有 `docs/ai01-docs/` 未跟踪内容。
...
- [ ] Save rerun report to `docs/ai01-docs/test/2026-05-22-full-test-rerun-report.md`.
