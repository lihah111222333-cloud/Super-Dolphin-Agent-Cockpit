...
| G5 | P0 | mcp-orch SQLite regression | go test ./cmd/mcp-orch ./internal/sidecar/orch/fxadapter ./internal/sidecar/orch/orchestration ./internal/sidecar/orch/store/commandcard ./internal/sidecar/orch/store/workspace ./internal/sidecar/orch/store/taskdag ./internal/sidecar/orch/tools -run TestSQLite -count=1 | . | 2026-06-15T05:01:06Z | 2026-06-15T05:01:14Z | 0 | .tmp/final-release-logs/G5.log | PASS |  |
...
| G7 | P0 | DAG wakeup claim concurrency | go test ./internal/sidecar/orch/store/taskdag -run TestSQLiteWakeupClaimConcurrentGoroutinesAndProcesses -count=1 | . | 2026-06-15T05:01:16Z | 2026-06-15T05:01:19Z | 0 | .tmp/final-release-logs/G7.log | PASS |  |
| G8 | P0 | SQLite runtime lock replacement | go test ./internal/sidecar/orch/store/taskdag -run TestSQLiteRuntimeLock -count=1 | . | 2026-06-15T05:01:19Z | 2026-06-15T05:01:21Z | 0 | .tmp/final-release-logs/G8.log | PASS |  |
...
| G10 | P0 | DAG JSON event golden | go test ./internal/sidecar/orch/store/taskdag -run TestSQLiteRunEventAppendGoldenPayloads\|TestSQLiteRunEventAppendConcurrentWritersDoNotOverwrite -count=1 | . | 2026-06-15T05:01:23Z | 2026-06-15T05:01:25Z | 0 | .tmp/final-release-logs/G10.log | PASS |  |
...
| G14 | P1 | Regression, performance, backup restore | go test -v -tags sqlite_stress ./internal/platform/db/sqlite ./internal/module/dashboard ./internal/store/... ./cmd/mcp-orch ./internal/sidecar/orch/fxadapter ./internal/sidecar/orch/orchestration ./internal/sidecar/orch/store/commandcard ./internal/sidecar/orch/store/workspace ./internal/sidecar/orch/store/taskdag ./internal/sidecar/orch/tools -run TestSQLiteBackupRestoreSmoke\|TestSQLiteQueryPlanSmoke\|TestSQLiteMediumFixtureDistribution\|TestSQLiteLargeFixtureStressExplicitRun\|TestDashboardDAGSnapshotListQueryCountDoesNotScaleWithPageSize\|TestSQLite -count=1 | . | 2026-06-15T05:06:59Z | 2026-06-15T05:07:43Z | 0 | .tmp/final-release-logs/G14.log | PASS | sqlite-switch release owner |
