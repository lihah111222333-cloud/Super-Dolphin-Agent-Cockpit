...
| `internal/module/orchestration/service.go` | 395 | 358 | 超过 350；未超过 400 红线 |
...
| `NewOrchestrationHandlers` | `internal/module/orchestration/rpc.go:15-77` | 63 | 63 | 1 | 5 | 超过 60；未超过 80 |
...
| 6 | `reconcileReadyStateLocked` | `internal/module/orchestration/helpers.go:119-138` | 20 | 2 | 10 | 通过 |
| 7 | `inputItemsFromSubmitParams` | `internal/module/orchestration/rpc.go:106-125` | 20 | 2 | 10 | 通过 |
