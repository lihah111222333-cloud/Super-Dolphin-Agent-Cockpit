...
- 与之相比，orchestration 侧 `internal/module/orchestration/helpers.go:147-153` 和 `internal/module/orchestration/service.go:244-250` 把活跃 turn ID 视为本地/orchestration ID（`ExpectedTurnID` 或派生 ID）。
