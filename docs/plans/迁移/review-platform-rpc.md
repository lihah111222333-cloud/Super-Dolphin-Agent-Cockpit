...
- 当前 `rpc_handlers` producer 只有 5 处：`internal/module/orchestration/rpc.go:15-77`、`internal/module/skill/rpc.go:42-88`、`internal/module/thread/rpc.go:18-84`、`internal/module/turn/rpc.go:14-93`、`internal/module/workspace/rpc.go:13-24`。
- 这 5 处输出的所有 method 都使用 `rpc.StrictHandler(...)`、`rpc.ThreadHandler(...)` 或 `rpc.CapabilityThreadHandler(...)`。例如：
  - orchestration：`internal/module/orchestration/rpc.go:16-76`
...
- handler producer 来自 5 个业务模块：
  - `internal/module/orchestration/rpc.go:15-77`
