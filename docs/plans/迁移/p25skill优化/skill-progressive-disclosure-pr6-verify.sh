...
SCRIPTS=(
  ...
  "${SCRIPT_DIR}/skill-progressive-disclosure-rollout-append.sh"
  "${SCRIPT_DIR}/skill-progressive-disclosure-rollout-status.sh"
  "${SCRIPT_DIR}/skill-progressive-disclosure-rollout-daily.sh"
  "${SCRIPT_DIR}/skill-progressive-disclosure-production-smoke-evidence-generate.sh"
  "${SCRIPT_DIR}/skill-progressive-disclosure-claudecli-e2e-evidence-generate.sh"
...
Verified:
- rollout / smoke / report / append / status / daily / production-evidence / claudecli-e2e-evidence / gate / preflight / evidence bundle / evidence collect / phase3-evidence-status / default-switch scripts parse with bash -n and are executable.
