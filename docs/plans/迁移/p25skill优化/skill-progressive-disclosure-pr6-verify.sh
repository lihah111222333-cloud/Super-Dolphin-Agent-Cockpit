...
Verified:
- rollout / smoke / report / append / status / daily / production-evidence / gate / preflight / evidence bundle / evidence collect / default-switch scripts parse with bash -n and are executable.
