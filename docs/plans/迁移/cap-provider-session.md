...
- 审查对象覆盖：
  - V3：`internal/provider/*`、`internal/module/thread/*`、`internal/module/turn/*`、`internal/module/orchestration/*`、`internal/store/*`
...
- orchestration cleanup：
  - `StopAgent`：`internal/module/orchestration/service.go:127-141`
  - `StopAllAgents`：`internal/module/orchestration/service.go:143-153`
  - 进程退出：`internal/module/orchestration/service.go:355-370`
