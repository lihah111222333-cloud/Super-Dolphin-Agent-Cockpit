...
| --- | --- | --- | --- |
| `HandlerMapResult` | `internal/platform/rpc/module.go:36` | `internal/module/orchestration/rpc.go:15,16`；`internal/module/skill/rpc.go:42,43`；`internal/module/thread/rpc.go:19,20`；`internal/module/turn/rpc.go:19,32`；`internal/module/workspace/rpc.go:13,14` | 5 个业务模块复用，满足 >=3 |
| `ResilientSubscribe[T]` | `internal/platform/bus/resilient.go:10` | `internal/module/orchestration/module.go:33,39`；`internal/platform/rpc/push.go:82,85,88`；`internal/ui/wails/bridge.go:54,57,60` | 3 个消费包，满足“包级复用”；若只按 `internal/module/` 业务模块计数，则仅 orchestration 1 个，不满足 |
...
| --- | --- | --- | --- | --- |
| orchestration | `internal/module/orchestration/module.go:1` | `internal/module/orchestration/contract.go:1` | `internal/module/orchestration/service.go:1` | 通过 |
...
- `internal/module/orchestration/rpc.go:40` `agent.stop`
- `internal/module/orchestration/rpc.go:46` `agent.snapshot`
- `internal/module/orchestration/rpc.go:49` `agent.getState`
- `internal/module/orchestration/rpc.go:52` `agent.getReport`
...
- `internal/module/orchestration/rpc.go:43`
