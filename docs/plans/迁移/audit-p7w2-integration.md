...
- `internal/module/orchestration/execution_test.go` [internal/module/orchestration/execution_test.go:16](/Volumes/bot/super-agent-v3/internal/module/orchestration/execution_test.go#L16)
- `internal/module/orchestration/submission_test.go` [internal/module/orchestration/submission_test.go:17](/Volumes/bot/super-agent-v3/internal/module/orchestration/submission_test.go#L17)
- `internal/module/orchestration/turn_lifecycle_test.go` [internal/module/orchestration/turn_lifecycle_test.go:14](/Volumes/bot/super-agent-v3/internal/module/orchestration/turn_lifecycle_test.go#L14)
...
- `orchestration` 必须至少覆盖 `agent.launch` -> `agent.submitPrompt` -> `agent.getState` -> `agent.getReport`，以及 V3 新增的 `task/dag/create|get|list`、`task/node/update`；见 [internal/module/orchestration/rpc.go:17](/Volumes/bot/super-agent-v3/internal/module/orchestration/rpc.go#L17) 到 [internal/module/orchestration/rpc.go:75](/Volumes/bot/super-agent-v3/internal/module/orchestration/rpc.go#L75)。
