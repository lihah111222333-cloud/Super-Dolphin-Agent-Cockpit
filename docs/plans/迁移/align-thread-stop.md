...
- `thread/delete`：`❌`
  ...
  - V3 没有接上 `orchestration.StopAgent` / `SessionManager.Remove`，所以事件、资源回收、僵尸防护都不等价：`internal/module/orchestration/service.go:127-140,155-164`，`internal/provider/unified/session.go:60-85`
