...
- V3 已有 orchestration RPC handler 映射，但它们只在 `internal/module/orchestration` 模块内定义为 app/RPC handler，不是 `cmd/mcp-orch` 暴露出来的 MCP tool：`internal/module/orchestration/module.go:15-23`、`internal/module/orchestration/rpc.go:15-77`。
...
|---|---|---|---|
| `orchestration_list_agents` | `go-agent-v2/pkg/toolsdk/tools/orchestration.go:232-240` | RPC `agent.list`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:43-45`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `orchestration_send_message` | `go-agent-v2/pkg/toolsdk/tools/orchestration.go:245-258` | 近似 RPC `agent.submit` / `agent.submitPrompt`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:20-39`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `orchestration_launch_agent` | `go-agent-v2/pkg/toolsdk/tools/orchestration.go:262-278` | RPC `agent.launch`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:17-19`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `orchestration_stop_agent` | `go-agent-v2/pkg/toolsdk/tools/orchestration.go:282-294` | RPC `agent.stop`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:40-42`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `orchestration_get_agent_report` | `go-agent-v2/pkg/toolsdk/tools/orchestration.go:298-310` | RPC `agent.getReport` / `orchestration/report`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:52-54`、`internal/module/orchestration/rpc.go:73-75`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `task_create_dag` | `go-agent-v2/pkg/toolsdk/tools/resource_specs.go:45-53` | RPC `task/dag/create`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:61-63`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `task_get_dag` | `go-agent-v2/pkg/toolsdk/tools/resource_specs.go:69-78` | RPC `task/dag/get`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:64-66`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
| `task_update_node` | `go-agent-v2/pkg/toolsdk/tools/resource_specs.go:82-96` | RPC `task/node/update`，但未接入 `cmd/mcp-orch`：`internal/module/orchestration/rpc.go:70-72`、`cmd/mcp-orch/fx.go:5-12` | ❌ |
...
- V3 当前 `cmd/mcp-orch` 还是空壳，现阶段没有任何已注册的 MCP orchestration family tool；虽然代码库已经有 orchestration / workspace 的 RPC handler 和 command/prompt/sharedfile 的 store 层，但都没有被组装进 `cmd/mcp-orch`：`cmd/mcp-orch/fx.go:5-12`、`internal/module/orchestration/rpc.go:15-77`、`internal/module/workspace/rpc.go:13-24`、`internal/store/commandcard/contract.go:10-15`、`internal/store/prompt/contract.go:10-13`、`internal/store/sharedfile/contract.go:9-11`。
