...
`internal/module/orchestration/contract.go` 的 `Service` 只有 `6` 个方法：
...
- `internal/module/orchestration/contract.go:10-17`
  - `Service` 只有 `LaunchAgent/StopAgent/SubmitTurn/CompleteTurn/Recover/Snapshot`
  - 没有 `ListAgents`
- `internal/module/orchestration/helpers.go:123-137`
