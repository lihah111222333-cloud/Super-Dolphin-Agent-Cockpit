...
- `internal/module/orchestration/session_generation.go:29-40` 清理链路优先走 `RemoveSessionGeneration`。
...
- 已转为 snake_case 的主路径示例：
  - `internal/module/orchestration/rpc_types.go:15`
  - `internal/module/orchestration/rpc_types.go:58`
  - `internal/module/orchestration/rpc_types.go:81`
  - `internal/module/orchestration/rpc_types.go:104-105`
