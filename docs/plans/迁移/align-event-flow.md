...
- V3 核心来源
  ...
  - `internal/module/orchestration/events.go:13-64`
...
3. orchestration 和 workspace 也直接往 typed bus 发事件，见 `internal/module/orchestration/events.go:13-64`、`internal/module/workspace/service.go:49-58`、`internal/module/workspace/service_helpers.go:220-284`。
...
- 当前源码能确认 live publish 的主要是：
  - agent：provider translator + orchestration 都会发，见 `internal/provider/codexapp/event_map.go:40-75`、`internal/provider/claudecli/event_map.go:35-53`、`internal/module/orchestration/events.go:13-64`
