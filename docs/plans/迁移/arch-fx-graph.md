...
- `taskdag.Store` 被 `orchestration.NewService` 消费，见 `internal/module/orchestration/service.go:80-102`
...
| `orchestration.NewOrchestrationHandlers` | `internal/module/orchestration/rpc.go:15-77` |
...
| `orchestration.NewRunnerActor` | `internal/module/orchestration/runner_actor.go:22-24`，注解在 `internal/module/orchestration/module.go:20` |
...
1. `thread.Service`
   ...
   证据：`internal/module/thread/service.go:40-47`、`internal/app/thread_orchestration_adapter.go:14-16`、`internal/module/orchestration/service.go:80-102`、`internal/module/turn/orchestration_starter.go:18-20`、`internal/module/turn/service.go:26-37`
