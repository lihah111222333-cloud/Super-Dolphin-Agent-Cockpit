...
证据：`internal/app/app.go:17-21`，`internal/app/runner.go:13-61`，`internal/module/orchestration/module.go:15-23`，`internal/app/modules.go:46-48`。
...
| 文件 | key 数 |
|---|---:|
| `internal/module/orchestration/rpc.go` | 15 |
