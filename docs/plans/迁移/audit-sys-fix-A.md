...
- S3 的 shutdown 生命周期存在 delete-before-close 窗口：runtime stop 会先触发 `StopAllAgents -> RemoveSession`，随后 `CloseAll` 只能关闭仍留在 map 中的 session，见 `internal/app/runner.go:48-58`、`internal/module/orchestration/runner_actor.go:36-39`、`internal/module/orchestration/service.go:130-137`、`internal/provider/unified/session_adapter.go:29-34`、`internal/provider/unified/session.go:59-67`、`internal/provider/unified/module.go:37-39`。
