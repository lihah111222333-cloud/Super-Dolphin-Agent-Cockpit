...
最终候选冻结：`SCORE_BASE=897040582c3daa90138fed1b3607aaa63fb7a66d`；后续 SUBJECT 仅包含本收口记录，评分与总审结论仍以提交绑定的原始证据为准。
