...
## 3. 阶段 F 功能（37 行 / 27 未开工 + 9 ✅ done + 1 完成占位）

> **口径说明**：37 表位 ÷ 状态 = 9 条 strikethrough ✅ done（F1.1 / F2.0 / F2.1 / F4.0 / F5.1 / F5.2 / F5.3 / F6.2 / F6.4）+ 1 条 F6.1 完成占位（由 T1.2-mid 接手 snapshot）+ 27 条未开工。“待做”传统口径只扣“完成占位”不扣 done，本文档接手人读“36 待做”时请同时看本说明。
>
