...
## 3. 阶段 F 功能（38 行 / 12 未开工 + 21 ✅ done + 1 完成占位 + 4 降 H：详 ADR-014）

> **口径说明**：38 表位 ÷ 状态 = 21 条 strikethrough ✅ done（F1.1 / F1.2 / **F1.3** / F1.5 / F2.0 / F2.1 / F2.2 / F4.0 / F4.1 / F4.2 / F4.5 / F5.1 / F5.2 / F5.3 / F6.2 / F6.3 / F6.4 / F7.1 / **F7.2** / **F7.3** / **F14.1**）+ 1 条 F6.1 完成占位（由 T1.2-mid 接手 snapshot）+ 4 条 ⏸ 降 H（F3.1 / F3.2 / F3.3 / F3.4，详 ADR-014：prompt_template-first 路线下 hybrid 节点可由 agent+depends_on 两节点表达）+ 12 条未开工。
>
