...
- `docs/审查报告/前端项目资料/审查文档/frontend-app-vs-agent-terminal-backend-interface-diff-2026-06-03.md` records the current frontend RPC surface and confirms that `backendApi.js` is the current React UI's auditable RPC list.
