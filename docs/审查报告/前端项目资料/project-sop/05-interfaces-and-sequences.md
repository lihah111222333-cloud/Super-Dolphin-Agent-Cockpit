...
| mcp-orch RPC | `internal/sidecar/orch/orchestration/rpc.go`、`internal/sidecar/orch/workspace/rpc.go` | agent、DAG、workspace 运行控制 |
| mcp-lsp tools | `internal/sidecar/lsp/tools.go` | file、inspect、xref、grep、structure、edit、completion |
