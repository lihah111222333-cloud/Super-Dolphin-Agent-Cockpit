...
| mcp-orch 工具面包含 launch/list/send/stop、DAG、workspace、prompt、shared file | `cmd/mcp-orch/tools/registry.go` |
| mcp-lsp 工具面覆盖 file/inspect/xref/grep/structure/edit/completion | `cmd/mcp-lsp/tools.go` |
