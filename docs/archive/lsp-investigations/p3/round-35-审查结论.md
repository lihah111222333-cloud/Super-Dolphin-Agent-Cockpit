...
- `cmd/mcp-orch/store/taskdag/factory.go`（queryOne、queryMany、queryValue、mapRows、parseLeaseDuration、bindWakeupTurnTx、fencedWakeupMutation、wakeupFenceFromMark/Retry/Fail）
