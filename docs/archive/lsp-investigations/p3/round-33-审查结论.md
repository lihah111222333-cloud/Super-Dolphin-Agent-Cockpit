...
- `cmd/mcp-lsp/edit/replaceutil.go`（GuardContentAndReplacement、ShouldForceBypass、OffsetToLine、BuildEditContext、indexContent、lineForOffset、lineRangeForOffsets、validateOffsets、splitAffectedLines）
- `cmd/mcp-lsp/protocol/codec.go`（BuildRequest、BuildNotification、BuildSuccessResponse、BuildErrorResponse、EncodeMessage、DecodeEnvelope、DecodeRequest、DecodeNotification、DecodeResponse、hasRequestID、marshalPayload）
