...
- `cmd/mcp-lsp/manager/scope.go`（ToolScope、ResolvedToolScope、ScopedManager、ScopedManagerResolver、WithResolvedToolScope、ResolvedToolScopeFromContext、ManagerWithResolvedScope、resolvedScopeManager 18 个 method 装饰）
- `cmd/mcp-lsp/multilsp/registry_scope.go`（registryScopedResolver、ForToolScope、CurrentManagersForToolScope、resolveRegistryScope、adapterForLanguage、registryBaseScope、registryTargetURI、registryLanguageID、normalizeRegistryWorkspaceRoot、registryScopeKey、managerScopedManager、managerToolScope）
