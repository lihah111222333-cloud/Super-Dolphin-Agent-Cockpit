...
- `shared_file_write` 已有 10MiB 内容上限和系统 handoff 路径保护（`cmd/mcp-orch/tools/shared_file_tools.go:79-105`、`cmd/mcp-orch/tools/parity_v2_test.go:260-300`），本轮不报告无限大写入或覆盖系统 handoff。
