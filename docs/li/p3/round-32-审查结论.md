...
- `cmd/mcp-lsp/tools/tool_edit_lock.go`（lockEditFile、lockEditFiles）
- `cmd/mcp-lsp/tools/tool_error_envelope.go`（newToolErrorEnvelope re-export）
- `cmd/mcp-lsp/format/compact.go`（NormalizeVerbosity、ResolveResultLimit、CompactCompletionItems、CompactWorkspaceSymbols、LocationFromAny、locationFromMap、intFromAny、GroupLocationsByFile）
- `cmd/mcp-lsp/format/funcrange.go`（FindEnclosingFunction、EnrichLocationResultsWithFuncRange、ResolveEnclosingFunctionRange、AbsolutePathFromURI）
