...
| Script | Purpose |
|--------|---------|
| `scripts-design/icon/generate.py` | Generate SVG icons with Gemini 3.1 Pro Preview |
...
python3 scripts-design/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```
...
```bash
python3 scripts-design/icon/generate.py --list-styles
python3 scripts-design/icon/generate.py --list-categories
```
