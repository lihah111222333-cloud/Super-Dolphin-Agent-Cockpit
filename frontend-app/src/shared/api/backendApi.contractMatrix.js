...
export const RPC_CONTRACT_REGISTRY = Object.freeze({
  ...
  OBSERVABILITY_TRACE_GET: contract('OBSERVABILITY_TRACE_GET', 'observabilityPageService.getObservabilityTrace', 'P1', 'observability', [TESTS.API, TESTS.OBSERVABILITY, TESTS.OBSERVABILITY_PAGE_SERVICE], ['observability query']),
  ...
  OBSERVABILITY_RECENT_LIST: contract('OBSERVABILITY_RECENT_LIST', 'observabilityPageService.listObservabilityRecent', 'P1', 'observability', [TESTS.API, TESTS.OBSERVABILITY, TESTS.OBSERVABILITY_PAGE_SERVICE], ['observability query']),
  ...
  UI_MEMORY_ENTRY_GET: contract('UI_MEMORY_ENTRY_GET', 'memoryPageService.getMemoryEntry', 'P1', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory read']),
  UI_MEMORY_ENTRY_UPSERT: contract('UI_MEMORY_ENTRY_UPSERT', 'memoryPageService.upsertMemoryEntry', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory mutation']),
  UI_MEMORY_ENTRY_DELETE: contract('UI_MEMORY_ENTRY_DELETE', 'memoryPageService.deleteMemoryEntry', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory mutation']),
  UI_MEMORY_AUTO_DREAM_SET_INTENT: contract('UI_MEMORY_AUTO_DREAM_SET_INTENT', 'memoryPageService.setMemoryAutoDreamIntent', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory automation mutation']),
  UI_MEMORY_ENTRY_MERGE: contract('UI_MEMORY_ENTRY_MERGE', 'memoryPageService.mergeMemoryEntries', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory mutation']),
  UI_MEMORY_SIMILARITY_IGNORE: contract('UI_MEMORY_SIMILARITY_IGNORE', 'memoryPageService.ignoreMemorySimilarity', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory mutation']),
  ...
  UI_MEMORY_SIMILARITY_CONSOLIDATE_ALL_START: contract('UI_MEMORY_SIMILARITY_CONSOLIDATE_ALL_START', 'memoryPageService.startConsolidateMemorySimilarities', 'P0', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory mutation']),
  UI_MEMORY_SIMILARITY_CONSOLIDATE_ALL_STATUS: contract('UI_MEMORY_SIMILARITY_CONSOLIDATE_ALL_STATUS', 'memoryPageService.getMemoryConsolidationStatus', 'P1', 'memory', [TESTS.API, TESTS.MEMORY, TESTS.MEMORY_PAGE_SERVICE], ['memory read']),
  UI_SHARED_FILE_GET: contract('UI_SHARED_FILE_GET', 'filesPageService.readSharedFile', 'P1', 'memory', [TESTS.API, TESTS.WORKFLOWS, TESTS.FILES_PAGE_SERVICE], ['shared file read']),
  ...
  PROMPT_ASSETS_LIST: contract('PROMPT_ASSETS_LIST', 'promptPageService.listPromptAssets', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt read']),
  DASHBOARD_PROMPTS: contract('DASHBOARD_PROMPTS', 'promptPageService.getDashboardPrompts', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt read']),
  PROMPTS_GET: contract('PROMPTS_GET', 'promptPageService.getPrompt', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt read']),
  PROMPTS_WRITE: contract('PROMPTS_WRITE', 'promptPageService.writePrompt', 'P0', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt mutation']),
  PROMPTS_DELETE: contract('PROMPTS_DELETE', 'promptPageService.deletePrompt', 'P0', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt mutation']),
  PROMPT_INTENTS_DRAFT: contract('PROMPT_INTENTS_DRAFT', 'promptPageService.draftPromptIntent', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt draft generation']),
  PROMPT_INTENTS_COMMIT: contract('PROMPT_INTENTS_COMMIT', 'promptPageService.commitPromptIntent', 'P0', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt mutation']),
  PROMPT_INTENTS_DISCARD: contract('PROMPT_INTENTS_DISCARD', 'promptPageService.discardPromptIntent', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt draft lifecycle']),
  PROMPT_INTENTS_DRY_RUN: contract('PROMPT_INTENTS_DRY_RUN', 'promptPageService.dryRunPromptIntent', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['prompt preview']),
  PERSONALIZATION_PROFILE_GET: contract('PERSONALIZATION_PROFILE_GET', 'promptPageService.getPersonalizationProfile', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['personalization profile']),
  PERSONALIZATION_PROFILE_SAVE: contract('PERSONALIZATION_PROFILE_SAVE', 'promptPageService.savePersonalizationProfile', 'P1', 'prompt', [TESTS.API, TESTS.PROMPTS, TESTS.PROMPT_PAGE_SERVICE], ['personalization profile']),
  ...
  SKILL_TOOLS_CREATE: contract('SKILL_TOOLS_CREATE', 'createSkillTool', 'P0', 'skill', [TESTS.API, TESTS.SKILLS], ['skill tool mutation']),
  SKILL_TOOLS_LIST: contract('SKILL_TOOLS_LIST', 'listSkillTools', 'P1', 'skill', [TESTS.API, TESTS.SKILLS], ['skill tool read']),
  SKILL_TOOLS_GET: contract('SKILL_TOOLS_GET', 'getSkillTool', 'P1', 'skill', [TESTS.API, TESTS.SKILLS], ['skill tool read']),
  SKILL_TOOLS_UPDATE: contract('SKILL_TOOLS_UPDATE', 'updateSkillTool', 'P0', 'skill', [TESTS.API, TESTS.SKILLS], ['skill tool mutation']),
  SKILL_TOOLS_DELETE: contract('SKILL_TOOLS_DELETE', 'deleteSkillTool', 'P0', 'skill', [TESTS.API, TESTS.SKILLS], ['skill tool mutation']),
