...
describe('backend API contract matrix', () => {
  it('uses structured response policies with the locked final 138-entry partition', () => {
    ...
    expect(validators).toHaveLength(95);
    expect(EXPECTED_NEW_RESPONSE_VALIDATORS).toHaveLength(66);
    expect(policies).toHaveLength(39);
    ...
    expect(28 + EXPECTED_NEW_RESPONSE_VALIDATORS.length + newIgnoredKeys.length + 1).toBe(105);
    expect(EXPECTED_NEW_RESPONSE_VALIDATORS.length + newIgnoredKeys.length + 1).toBe(77);
